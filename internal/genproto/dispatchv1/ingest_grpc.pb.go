...
const (
	IngestionService_IngestEvent_FullMethodName = "/dispatch.v1.IngestionService/IngestEvent"
)
...
var IngestionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "dispatch.v1.IngestionService",
